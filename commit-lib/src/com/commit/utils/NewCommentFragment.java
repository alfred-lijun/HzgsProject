...
public class NewCommentFragment extends Fragment implements OnClickListener{
	...
	public static NewCommentFragment newInstance(Bundle bundle) {
		NewCommentFragment newFragment = new NewCommentFragment();
	...
	private void findView(){
		...
		mainView = inflater.inflate(R.layout.fragment_new_comment, null, false);
		mCommentEditText = (EditText) mainView.findViewById(R.id.et_sendmessage);
		mComments = (LinearLayout) mainView.findViewById(R.id.list);
		sendTx = (TextView) mainView.findViewById(R.id.iv_send);
	}
	...
	private void initView(){
		...
		sendTx.setOnClickListener(null);
		getComments();
	}
	...
	private OnCommentStateListener listener = new OnCommentStateListener() {
		...
		public void onSuccess(Comment comment) {
			...
			commentItem.setOnClickListener(NewCommentFragment.this);
			...
			if( commType == COMM_TYPE_PERSON || commType == COMM_TYPE_PUBLISH ){
				...
				deleteBtn.setOnClickListener(NewCommentFragment.this);
